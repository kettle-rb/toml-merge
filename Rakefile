...
# toml-merge Rakefile v1.0.0 - 2026-04-05
...
# rake install                                # Build and install toml-merge-1.0.0.gem in...
# rake install:local                          # Build and install toml-merge-1.0.0.gem in...
# rake kettle:jem:install                     # Install toml-merge GitHub automation and ...
# rake kettle:jem:selftest                    # Self-test: template toml-merge against itse...
# rake kettle:jem:template                    # Template toml-merge files into the curren...
